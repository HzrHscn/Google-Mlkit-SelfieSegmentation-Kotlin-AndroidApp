...
import com.example.myapplication.databinding.FragmentImageModeBinding
import com.example.myapplication.utils.GroundInstance
import com.example.myapplication.utils.ImageUtils
import com.example.myapplication.utils.LoadingDialog
import com.example.myapplication.utils.PermissionCheckerUtils
...
class ImageModeFragment : Fragment(), OnClickListener {
    ...
    private fun createSelfieWithBackground(uri: Uri?) {
        if (GroundInstance.getInstance()?.foreground != null){
            ...
            Toast.makeText(requireContext(), "Foreground image not found", Toast.LENGTH_SHORT).show()
            loading.dismiss()
        }
    }
